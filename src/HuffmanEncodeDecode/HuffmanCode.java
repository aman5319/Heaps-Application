...
public class HuffmanCode {
    public static void main(String[] args) {
        ...
        for (int j = 0; j < text.length(); j++) {
            s = s.append(codes[(int) (text.charAt(j))]);
            System.out.print(codes[(int) (text.charAt(j))]);
        }
        System.out.println();
        decode(s.toString(),tree.root);
    }
     ...
     */
  static   void decode(String S ,Tree.Node root)
    {
        if (root == null) return;
